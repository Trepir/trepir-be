...
-- CreateIndex
CREATE UNIQUE INDEX "TripDayActivity_accommodationId_key" ON "TripDayActivity"("accommodationId");

-- CreateIndex
CREATE UNIQUE INDEX "TripDayActivity_travelEventId_key" ON "TripDayActivity"("travelEventId");
...
-- AddForeignKey
ALTER TABLE "TripDayActivity" ADD CONSTRAINT "TripDayActivity_dayActivityId_fkey" FOREIGN KEY ("dayActivityId") REFERENCES "DayActivity"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TripDayActivity" ADD CONSTRAINT "TripDayActivity_accommodationId_fkey" FOREIGN KEY ("accommodationId") REFERENCES "accommodations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TripDayActivity" ADD CONSTRAINT "TripDayActivity_travelEventId_fkey" FOREIGN KEY ("travelEventId") REFERENCES "travel"("id") ON DELETE CASCADE ON UPDATE CASCADE;
